...
* 2026-07-13
    * Persistenceファイル保存で圧縮後のファイル容量を考慮し、より大容量のデータを保存できるようにしました
    * オートセーブをファイルに保存するように変更しました
    * 外部のMIDI入力でチャンネルをInstrumentに割り当てる機能を追加しました
    * VRで右スティックの下を押し続けてメニューを出せるようにしました
    * ゲームパッド接続時にシーケンサーが入力され続ける問題を修正しました
* 2025-07-15
